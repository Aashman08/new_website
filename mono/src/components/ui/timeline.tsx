    ...
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex justify-start pt-0 md:pt-40 md:gap-10"  // styling for timeline padding on top
          >
            ...
            <div className="sticky flex flex-col z-40 items-start top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 
              // className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-neutral-350 dark:text-neutral-500 "
        ...
        <div
          ...
          className="absolute md:left-8 left-8 top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[-60%] via-purple-600 to-blue-600 to-[99%] [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)]"  
        >
          <motion.div
            style={{
